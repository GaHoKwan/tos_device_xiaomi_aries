...
.method public readExternal(Ljava/io/ObjectInput;)V
    ...
    .line 120
    .local v1, "useFlyweightMapStorage":Z
    if-eqz v1, :cond_1
    ...
    .line 124
    new-instance v2, Lcom/android/i18n/phonenumbers/geocoding/FlyweightMapStorageExt;

    invoke-direct {v2}, Lcom/android/i18n/phonenumbers/geocoding/FlyweightMapStorageExt;-><init>()V

    iput-object v2, p0, Lcom/android/i18n/phonenumbers/geocoding/AreaCodeMap;->areaCodeMapStorage:Lcom/android/i18n/phonenumbers/geocoding/AreaCodeMapStorageStrategy;

    .line 131
    .end local v0    # "useExt":Z
    :goto_0
    iget-object v2, p0, Lcom/android/i18n/phonenumbers/geocoding/AreaCodeMap;->areaCodeMapStorage:Lcom/android/i18n/phonenumbers/geocoding/AreaCodeMapStorageStrategy;

    invoke-virtual {v2, p1}, Lcom/android/i18n/phonenumbers/geocoding/AreaCodeMapStorageStrategy;->readExternal(Ljava/io/ObjectInput;)V

    .line 132
    return-void

    .line 126
    .restart local v0    # "useExt":Z
    :cond_0
    new-instance v2, Lcom/android/i18n/phonenumbers/geocoding/FlyweightMapStorage;

    invoke-direct {v2}, Lcom/android/i18n/phonenumbers/geocoding/FlyweightMapStorage;-><init>()V
    ...
    .end local v0    # "useExt":Z
    :cond_1
    new-instance v2, Lcom/android/i18n/phonenumbers/geocoding/DefaultMapStorage;

    invoke-direct {v2}, Lcom/android/i18n/phonenumbers/geocoding/DefaultMapStorage;-><init>()V
